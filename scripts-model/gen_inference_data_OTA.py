...
def generate_infer_data_csv(root):
    ...
    # columns = ['key_v2v','strembed_v2v','libemb_v2v','embed_v2v','key_i2v','strembed_i2v', 'libembed_i2v','embed_i2v']
    ...
    data_df.to_csv('/Pramana/VexIR2Vec/Source_Binary/COFO-Dataset/C_data_infer_OTA_str_lib_only_test.csv', index=False)                
